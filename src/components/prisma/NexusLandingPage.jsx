...
export const NexusLandingPage = () => {
  ...
  const navItems = [
    ...
    { label: "Quick Search", action: () => setIsSearchOpen(true) },
  ];
  ...
  return (
    <div className="bg-black text-[#E1E0CC] min-h-screen selection:bg-[#DEDBC8] selection:text-black font-sans">
      {/* =========================================================
         SECTION 1: HERO (Full viewport height with inset padding & pristine video)
         ========================================================= */}
      <section className="h-screen p-4 md:p-6 relative bg-black">
        <div className="w-full h-full rounded-2xl md:rounded-[2rem] overflow-hidden relative bg-black border border-white/10">
          ...
          {/* Gradient Overlay */}
          <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-transparent to-black/60 z-2 pointer-events-none" />
      ...
      {/* =========================================================
         SECTION 2: ABOUT (Cinematic text reveal)
         ========================================================= */}
          ...
          <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl max-w-4xl mx-auto leading-[0.95] sm:leading-[0.9] text-[#E1E0CC] mb-12">
            <WordsPullUpMultiStyle
              segments={[
                ...
                { text: "a self-taught director.", className: "font-serif text-[#E1E0CC] italic" },
      ...
      {/* =========================================================
         SECTION 3: FEATURES (4-column card grid)
         ========================================================= */}
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 z-2">
                ...
                <span className="text-xs text-gray-400 mt-1 block">
                  Interactive Logic & Algorithm Engine
                </span>
              </div>
            </motion.div>
      ...
      <footer className="bg-black border-t border-white/10 py-12 px-6 text-center text-xs text-gray-500">
        <p className="m-0">© 2026 Prisma Creative Studio & Virtual Learning Platform. All Rights Reserved.</p>
      </footer>
    </div>
  );
};
